...
<!-- buttons generated from gosbil entities -->
            ...
            ${entitiesList.map(e => (`<a  ${e === entityName ? 'disabled' : `th:href="@{/${e}}"`}
        ...
        <div class="bg-white rounded-lg overflow-hidden shadow-lg">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-cyan-600 text-white">
                    ...
                    <tr>
                        ${entityFields.map(field =>
        `<th class="px-6 py-3 text-center font-bold tracking-wider">${field.name}</th>`
    ).join("\n")}
        <th class="px-6 py-3 text-center font-bold tracking-wider">Actions</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr th:each="${entityName} : \${${entityName}}" class="hover:bg-cyan-50 text-black">
                        ...
                        ${entityFields.map(field =>
        `<td class="px-6 py-4 whitespace-nowrap text-center" th:text="\${${entityName}.${field.name}}"></td>`
    ).join("\n")}
...
<body>
    ...
    <h1 class="bg-cyan-500 p-4 font-bold text-2xl
    text-white font-mono">${capAppName}</h1>
...
<!-- buttons generated from gosbil entities -->
        ${entitiesList.map(e => (`<a th:href="@{/${e}}" class="border-2 text-center h-fit hover:bg-cyan-600 cursor-pointer
